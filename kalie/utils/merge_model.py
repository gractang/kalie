...
import torch
import argparse
from cog_vlm_models.cogvlm_model import FineTuneTestCogVLMModel
...
def main():
    ...
    model = model.eval()
    model_args.save = './checkpoints/merged_model_{}_{}'.format(model_args.eva_args["image_size"][0], datetime.now().strftime('%Y-%m-%d-%H-%M'))
