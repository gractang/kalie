...
class MOKADataCollecter:
    def __init__(
        ...
        self.saved_planner_obs = [None] * 10
    ...
    def collect_trajectory_with_mouseclick(  # NOQA
        ...
        while True:
            ...
            print(self.skip_reset)

            skip_reset = (self.skip_reset and
                          self.saved_planner_obs[num_subtasks] is not None)
            ...
            if num_subtasks == 0:
                ...
                if skip_reset:
                    self.planner_obs = self.saved_planner_obs[num_subtasks]
                    input('Press [Enter] to continue to next step.')
                else:
                    self.env.reset(randomize=randomize_reset)
                    input('Press [Enter] to continue to next step.')
                    self.get_planner_observation()
                    self.saved_planner_obs[num_subtasks] = self.planner_obs
            ...
            resample_plan = False or self.skip_execution  # or self.skip_reset
            while True:
                ...
                if self.skip_confirmation and not self.skip_execution:
                    ch = 'y'
                else:
                    ch = input(
            ...
            # TODO(fangchen): Save planner_obs and context for each subtask.
            # This could be saved in a seprate file to avoid affecting policy
            # learning.
            ...
            for num_steps in range(self.config.max_subtask_steps):
                ...
                # Check Termination
                # TODO(fangchen): Double check this.
            ...
            # TODO(fangchen): Examine and complete this.
            ch = None
            while True:
    ...
    def prepare_info(self):
        ...
        info["version_number"] = cvp_version
