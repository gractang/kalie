...
from kalie.utils.grasp_utils import AntipodalDepthImageGraspSampler
...
class Planner(object):
    ...
    # for our project, I moved this to state_estimator for consistency
    # leaving it here also for legacy reasons/compatibility with Kuan's codes
    ...
    # previously sample_subtask
    def sample_context(self, obs, t):
        """Reset for the new task/episode.
