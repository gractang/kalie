    ...
    def _click_on_points(self, obs, grasp_proposals):  # NOQA
        ...
        def onclick(event):
            ...
            if point_id < 5:
                ...
                print(f'Clicked point #{point_id} at {point}')
                ...
                if not (x1 < point[0] < x2 and y1 < point[1] < y2):
                    if point_id == 0:
                        ...
                        print('Invalid function keypoint.')  # NOQA
                        self.points.append(None)  # function keypoint
                    elif point_id == 2:
                        print('Invalid target keypoint. Skip pre-contact and post-contact keypoint. Next, select only target point.')  # NOQA
                        self.points.append(None)  # target keypoint
                    else:
